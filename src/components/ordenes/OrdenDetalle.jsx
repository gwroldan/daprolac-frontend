...
const OrdenDetalle = ({ orden, proceso, ...props }) => {
  ...
  //       producto: state.producto === "" ? proceso.producto : state.producto
  //     });
  //   };
  ...
  //             ? event => handleEditarProceso(proceso.id, event)
  //             : handleHabilitaEditProceso
  //         }
  //         onBlur={
  //           state.producto.length
  ...
  return (
    <div>
      <div className={classes.root}>{renderTitleOrden()}</div>
      {console.log(orden.proceso.producto)}
      <div> {orden.proceso.producto}</div>
      {/* <div className={classes.root}>{renderTitleProceso()}</div> */}
      ...
      {/* <div className={classes.root}>
        ...
        <Button
          className={classes.agregarTarea}
          onClick={handleHabilitaAddTarea}
        >
          <AddCircleIcon style={{ marginRight: theme.spacing() }} />
          Agregar Tarea
        </Button>
